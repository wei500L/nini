...
from app.orchestrator import Orchestrator, SessionState
from app.schemas import Dossier, GuestOutput
...
class OrchestratorTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncTearDown(self) -> None:
        for orchestrator, session_id in self.created:
            if orchestrator.get_snapshot(session_id).state != SessionState.DONE:
